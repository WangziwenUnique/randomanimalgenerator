  ...
  nitro: {
    prerender: {
      ...
      routes: [
        ...
        '/tos',
        '/privacy_policy',
        '/shakespearean-translator/english-english',
        '/shakespearean-translator/haitian_creole-english',
        '/shakespearean-translator/old_english-english',
        '/standard/english-english',
        '/standard/haitian_creole-english',
        '/standard/old_english-english',
        '/academic/english-english',
        '/academic/haitian_creole-english',
        '/academic/old_english-english',
        '/simple/english-english',
        '/simple/haitian_creole-english',
        '/simple/old_english-english',
        '/flowing/english-english',
        '/flowing/haitian_creole-english',
        '/flowing/old_english-english',
        '/formal/english-english',
        '/formal/haitian_creole-english',
        '/formal/old_english-english',
        '/informal/english-english',
        '/informal/haitian_creole-english',
        '/informal/old_english-english',
        '/expand/english-english',
        '/expand/haitian_creole-english',
        '/expand/old_english-english',
        '/shorten/english-english',
        '/shorten/haitian_creole-english',
        '/shorten/old_english-english',
        '/old-english/old_english-english'
      ]
    },
    publicAssets: [
      {
